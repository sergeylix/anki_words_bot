...
MSG_GREETINGS = """🧠 Memorizing bot умеет сохранять слова, фразы и их перевод.\n
...
✍️ Чтобы добавить новое слово и отнести его к группе — <b>[слово] = [перевод] = [группа]</b>. *Названия групп могут быть любыми.
...
/words_in_groups_num — показать количество сохраненых слов в группах
...
MSG_CARDS_USER_GROUPS = """⚙️ Напиши <b>номер</b> группы, чтобы показывать слова из этой группы. 
