...
MSG_GREETINGS = """Этот бот уммет сохранять слова, фразы и их перевод. В режиме карточек можно просматривать ранее добавленные слова, вспоминать их перевод и выбирать, через сколько дней показать это слово в карточках в следующий раз.\n
1. Чтобы добавить новое слово напиши — <b>[слово] = [перевод]</b>.\n
------------------ПРИМЕР------------------
<b>amazing = замечательно</b>\n\n
2. Чтобы добавить новое слово и отнести его к группе — <b>[слово] = [перевод] = [группа]</b>. *Названия групп могут быть любыми.\n
------------------ПРИМЕР------------------
<b>could we have the check = можем мы получить счёт, пожалуйста = рестораны</b>
"""
...
MSG_WORDS_LAST = """15 последних добавленных слов:\n\n{clients_words}"""
MSG_WORDS_NUM = """Сохранено слов: <b>{words_num}</b>"""
MSG_WORDS_NUM_GROUP = """Сохранено слов в группах:\n\n{words_in_group}"""
